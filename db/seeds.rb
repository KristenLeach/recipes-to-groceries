...
recipes = Recipe.create([
    {name: "Eggos", description: "Only the greatest food on planet earth.", ingredients: ["eggo waffles", "toaster", "syrup"], directions: "Put the waffles in the toaster and heat them until toasted. Add syrup to your liking. Or, scrap all of that and just eat them frozen from the box.", user_id: 1, image: Rails.root.join("app/assets/images/eggo.jpg").open},
...
comments = Comment.create([
    {recipe_id: Faker::Number.between(1, 10), user_id: 1, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 2, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 3, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 4, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 5, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 6, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 7, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 8, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 9, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 10, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 1, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 2, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 3, content: Faker::Lorem.paragraph},
    {recipe_id: Faker::Number.between(1, 10), user_id: 4, content: Faker::Lorem.paragraph},
